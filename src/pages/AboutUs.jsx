...
export default function AboutUs() {
  ...
  const team = [
    { name: "Tapaswi", role: "Frontend Developer" },
    { name: "Nihari N", role: "Backend Developer" },
    { name: "Likhitha", role: "Backend Developer" },
    { name: "Vyshnavi", role: "Database Engineer" },
    { name: "Lalitha Sowmya", role: "Database Engineer" }
  ];
